    ...
    <body>                 
        ...
        <div class="content">
            <div class="content-header">
                ...
                <p class="header-footer">Error 500 Internal Server Error, Contact Admin For help</p>
            </div>
