...
<html>
    <head>
        <title>ThatGuyJack - Error 404</title>
        <link rel="icon" href="https://thatguyjack.co.uk/assets/img/icon.png"></link>
		<meta name="description" content="ThatGuyJack - Error 404">
		<meta name="icon" content="https://thatguyjack.co.uk/assets/img/icon.png"> 
		<meta property="og:title" content="ThatGuyJack">
		<meta property="og:description" content="ThatGuyJack - Error 404">
		<meta property="og:image" content="https://thatguyjack.co.uk/assets/img/icon.png">
		<meta name="keywords" content="ThatGuyJack">
		<link type="text/plain" rel="author" href="/humans.txt" />
        <link rel="stylesheet" href="https://thatguyjack.co.uk/assets/css/style.css"/>
        <style>
        .content-button{
            padding:15px 20px;
...
<script>
  ...
  gtag('config', 'G-1B4VZC6B39');
    ...
    <body>                 
        <div class="nav">
            <img class="nav-logo" id="logo" src="https://thatguyjack.co.uk/assets/img/default-monochrome.svg"/>
        </div>
        <div class="content">
            <div class="content-header">
                <h1 class="main-header">Oops Looks Like there was a error!</h1>
                <p class="header-footer">Error 404 Page Not Found, Contact Admin For help</p>
            </div>
